  ...
  return (
    <div className="footer">
      <div className="container-fluid">
        <h1>
          Aviation Medicine: <span className="small">a Medavex company</span>
        </h1>
      </div>
        ...
        <div className="row w-100">
          <div className="col-12 col-lg-6">
            ...
            <div className="col-12" style={{marginTop:'15px'}}>
              <span className="name1">Aviation Medicine,</span>{" "}
      ...
      <div className="container-fluid">
        <span className="bottom">© 2022 Copyright: flydocfl.com</span>
      </div>
    </div>    
  );
};
